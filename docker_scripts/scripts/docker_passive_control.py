...
class PassiveController(Node):
    def __init__(self, robot, freq: float = 100, node_name="passive_controller"):
        ...
        self.ds.set_parameter_value(
            "gain", [50.0, 50.0, 50.0, 10.0, 10.0, 10.0], sr.ParameterType.DOUBLE_ARRAY #standart linear DS
        )

        self.ctrl = create_cartesian_controller(CONTROLLER_TYPE.VELOCITY_IMPEDANCE)
        print("## PARAMS ## : ", self.ctrl.get_parameters())
        self.ctrl.set_parameter_value(
            "damping", np.diag([10.0, 10.0, 10.0, 0.0, 0.0, 0.0]), sr.ParameterType.MATRIX
        )
        self.ctrl.set_parameter_value(
        ...
        print("## PARAMS ## : ", self.ctrl.get_parameters())
        # self.ctrl.set_parameter_value(
        #     "linear_principle_damping", 10.0, sr.ParameterType.DOUBLE
        # )
        # self.ctrl.set_parameter_value(
        #     "linear_orthogonal_damping", 10.0, sr.ParameterType.DOUBLE
        # )
