...
class AnimationPassiveControllerComparison(Animator):
    ...
    def update_step(self, ii: int) -> None:
        ...
        velocity_D_frame = np.linalg.pinv(eig_vecs) @ desired_velocity * vel_scaling
        ...
        real_vel_factor = np.sum(
            (local_vels / (2 * axes_length * ellipse_factor)) ** pp
        )
...
if (__name__) == "__main__":
    ...
    animation_passive(save_animation=False)
